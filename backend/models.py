...
class User(db.Model, SerializerMixin):
    ...
    serialize_rules = ("-syllabi.user", "-study_plans.user", "-courses.user", "-_password_hash")
...
class Course(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-syllabi.course', '-user.courses')
...
class Progress(db.Model, SerializerMixin):
    ...
    serialize_rules = ("-study_plan.progress",)